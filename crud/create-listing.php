        ...
        for ($i = 0; $i < $num_files; $i++) {
            if ($_FILES["listing_pictures"]["error"][$i] == 0) {
                ...
                if (($file_type == "image/jpeg") || ($file_type == "image/png") || ($file_type == "image/jpg") || ($file_type == "image/bmp")) {
                    ...
                    $upload_dir1 = "../uploads/lister/listing/";
                    $target_file1 = $upload_dir1 . basename($file_name1);
                    move_uploaded_file($temp_name1, $target_file1);
    
                    // Insert record into database
                    $sql_list1 = "INSERT INTO listing_images (listing_id, user_filename, user_targetlocation) VALUES ('$userid','$file_name1', '$target_file1')";
