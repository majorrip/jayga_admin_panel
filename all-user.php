		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">Users Read Data</h4>
                                <a href="add-user.php" class="btn btn-primary float-right veiwbutton ">Add Users</a>
                            </div>
						</div>
					</div>
				</div>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["user_nid"] . "</td>";
                    echo "<td>" . $row["user_dob"] . "</td>";
                    echo "<td>" . $row["user_address"] . "</td>";
                    echo "<td>" . $row["is_lister"] . "</td>";
                    echo "<td>" . $row["platform_tag"] . "</td>";
                    echo "<td>" . $row["FCM_token"] . "</td>";
                    echo '<td class="text-right"><a href="#">Delete</a></td>';
                    echo "</tr>";
                }
            } else {
