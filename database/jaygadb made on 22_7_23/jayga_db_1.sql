...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2023 at 10:28 PM
...
--
ALTER TABLE `lister_nid`
  MODIFY `listing_nid_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `lister_user`
  MODIFY `lister_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `user_nid`
  MODIFY `user_nid_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `user_pictures`
--
ALTER TABLE `user_pictures`
  MODIFY `user_picture_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
COMMIT;
